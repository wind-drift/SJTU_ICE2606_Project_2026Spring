...
from .config import DEFAULT_DATA_DIR, DEFAULT_NOISE_PATH, FeatureConfig, TrainConfig
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--include-delta", action="store_true", default=FeatureConfig.include_delta)
...
def main() -> None:
    ...
    feature_config = FeatureConfig(
        ...
        n_mels=args.n_mels,
        n_mfcc=args.n_mfcc,
        include_delta=bool(args.include_delta) and not args.no_delta,
        include_delta_delta=FeatureConfig.include_delta_delta and not args.no_delta_delta,
